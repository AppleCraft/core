...
class MySQLConnectionPool implements Closeable {
	...
	MySQLConnectionPool(String url, String user, String password, String db) throws ClassNotFoundException {
		Class.forName("com.mysql.jdbc.Driver");
		this.url = "jdbc:mysql://" + url + ":3306/" + db;
		this.user = user;
		this.password = password;
		connections = new Vector<JDCConnection>(poolSize);
		ConnectionReaper reaper = new ConnectionReaper();
		new Thread(reaper, "MySQL Connection Reaper Thread - core").start();
	}
